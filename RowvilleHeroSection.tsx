...
interface RowvilleFenceTypesProps {
  onQuoteClick?: () => void;
}

const RowvilleFenceTypes = ({ onQuoteClick }: RowvilleFenceTypesProps) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10 sm:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">
            Choose Your Perfect Fence in Rowville
          </h2>
          <p className="text-base sm:text-xl text-white/70 max-w-3xl mx-auto px-4">
            Discover Rowville fencing options tailored to your needs, budget, and style.
          </p>
        </div>
          ...
          {fenceTypes.map((fence) => (
            ...
            >
              ...
              <CardHeader className="text-center">
                ...
                <div className="text-muted-foreground text-sm font-normal text-center">Rowville</div>
        ...
        <div className="mt-16 text-center">
          <div className="card-gradient rounded-2xl p-8 shadow-soft border border-border">
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Our expert Rowville team can help you select the perfect fencing solution based on your specific needs, budget, and property requirements.
            </p>
