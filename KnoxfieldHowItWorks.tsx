...
const KeysboroughFAQSection = () => {
  const faqs = [
    { question: "How much does fencing cost in Keysborough?", answer: "Colorbond typically costs $75-$120/m, timber $65-$140/m, aluminium pool fencing $150-$300/m." },
    { question: "Do I need a permit for fencing in Keysborough?", answer: "In Keysborough (Greater Dandenong Council), fences under 2m generally don't require a permit." },
    { question: "What's the best fence for Keysborough?", answer: "Colorbond is popular in Keysborough for its durability and modern appearance." },
    ...
    { question: "What areas do you service?", answer: "Keysborough and surrounds including Noble Park, Springvale, Dandenong, Dingley Village." },
    ...
    { question: "Do you service new estates?", answer: "Yes! We're experienced with new housing developments in Keysborough." },
  ];
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Keysborough Fencing FAQs</h2>
...
export default KeysboroughFAQSection;
