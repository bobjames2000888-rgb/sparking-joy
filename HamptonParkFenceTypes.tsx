...
const HallamFenceTypes = () => (
  <section className="py-16">
    <div className="container mx-auto px-4">
      <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">Hallam Fence Types</h2>
      <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">Choose from our range of quality fencing options available in Hallam</p>
...
export default HallamFenceTypes;
