...
const Darwin = () => {
  useDocumentTitle("Darwin Fencing Quotes — Get 3 Free Quotes in Minutes");
  ...
  const recentProjects = [{
    ...
    rating: 5,
    review: "Everything was handled efficiently and with care. The crew arrived as promised and delivered a fence that looks outstanding."
  }, {
    suburb: "Parap",
    type: "Timber Fence",
    rating: 5,
    review: "Impressive build quality paired with sensible pricing. A team I'd confidently recommend."
  }, {
    suburb: "Stuart Park",
    type: "Timber Fence",
    rating: 5,
    review: "The outcome went well beyond what we anticipated. The fence is beautifully finished and the service was exceptional throughout."
  }];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center space-x-2 bg-primary/10 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-medium text-primary">Servicing All Darwin Suburbs</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
              Darwin's Most Trusted
              <br />
              <span className="text-gradient">Fencing Specialists</span>
            </h1>
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">Professional fencing installation and repair services across Greater Darwin. Local tradies, trusted by 600+ Darwin homeowners.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              We Service All Darwin Suburbs
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              From Palmerston to Nightcliff, we've got Darwin covered
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
            {suburbs.map((suburb, index) => <SuburbLink key={index} suburb={suburb} cityPath="/darwin" />)}
          </div>
          
          {/* Expanded suburbs list */}
          {showAllSuburbs && <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
              {allSuburbs.map((suburb, index) => <SuburbLink key={index} suburb={suburb} cityPath="/darwin" />)}
            </div>}
          
          <div className="text-center">
            <p className="text-muted-foreground mb-4">Don't see your suburb? We service the entire Greater Darwin area!</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
                Why Darwin Homeowners Choose Us
              </h2>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground mb-1">Local Darwin Experts</h3>
                    <p className="text-muted-foreground text-sm">Local contractors understand Darwin's unique weather, council requirements, and local styles</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 accent-gradient rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Same-day quotes and flexible scheduling to suit your Darwin lifestyle</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 accent-gradient rounded-full flex items-center justify-center flex-shrink-0 mt-1">
            ...
            <div className="relative">
              <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-elegant">
                <img alt="Darwin Fencing Projects" className="w-full h-full object-cover" src="/lovable-uploads/6d573bf3-2ef8-45eb-b8e9-df0db865b8d5.webp" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="accent-gradient rounded-2xl p-12 shadow-elegant">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Ready to Get Your Darwin Fence Installed?
            </h2>
            <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">Join happy Darwin homeowners. Get your free quotes in 60 seconds.</p>
            <Button variant="secondary" size="lg" onClick={handleQuoteClick}>Get Free Darwin Quotes</Button>
          </div>
        </div>
      </section>
