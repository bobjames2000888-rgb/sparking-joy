...
const BalwynFAQSection = () => {
  const faqs = [
    { question: "How much does fencing cost in Balwyn?", answer: "Colorbond typically costs $75-$120/m, timber $65-$140/m, aluminium pool fencing $150-$300/m." },
    { question: "Do I need a permit for fencing in Balwyn?", answer: "In Balwyn (Boroondara Council), fences under 2m generally don't require a permit. Heritage overlays may apply." },
    { question: "What's the best fence for Balwyn?", answer: "Timber and heritage-style fencing suit Balwyn's character homes. Colorbond is popular for modern builds." },
    ...
    { question: "What areas do you service?", answer: "Balwyn and surrounds including Kew, Camberwell, Box Hill, Doncaster." },
    ...
    { question: "Do you work with heritage properties?", answer: "Yes! Our contractors are experienced with heritage requirements in Balwyn." },
  ];
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Balwyn Fencing FAQs</h2>
...
export default BalwynFAQSection;
