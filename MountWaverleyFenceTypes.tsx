...
const MountMarthaFAQSection = ({
  ...
  const faqs = [{
    ...
    question: "Do I need my neighbour's approval for a new boundary fence in Mount Martha?",
    ...
    question: "How close to the boundary can I build my fence in Mount Martha?",
    ...
    question: "How do I choose the right fence for my home in Mount Martha?",
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Got questions about fencing in Mount Martha? We've got answers. Here's everything you need to know about
            getting your perfect fence installed in Mount Martha.
          </p>
        </div>
        ...
        <div className="text-center mt-12 p-8 rounded-2xl bg-gradient-to-r from-primary/5 via-accent/5 to-primary/5 border border-accent/20">
          ...
          <p className="text-muted-foreground mb-6">
            Our local fencing experts in Mount Martha are here to help. Get your free quotes and ask them anything!
          </p>
...
export default MountMarthaFAQSection;