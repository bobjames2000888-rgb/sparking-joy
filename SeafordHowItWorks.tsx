      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <Badge variant="secondary" className="mb-6 px-4 py-2 text-sm font-medium">
            ...
            Trusted by 500+ Scoresby Homeowners
          </Badge>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 leading-tight">
            Professional Fencing in <span className="text-primary">Scoresby</span>
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Get 3 free quotes from verified local fencing contractors in Scoresby. Compare prices, read reviews, and choose the best fencer for your property.
          </p>
          <Button size="lg" onClick={handleQuoteClick} className="text-lg px-8 py-6 mb-8 shadow-lg hover:shadow-xl transition-all">
...
export default ScoresbyHeroSection;
