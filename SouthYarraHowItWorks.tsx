...
const SomervilleHowItWorks = () => {
  const steps = [
    { icon: FileText, title: "Describe Your Project", description: "Tell us about your fencing needs in Somerville.", step: "01" },
    { icon: Users, title: "Get Matched", description: "We connect you with up to 3 verified Somerville fencing contractors.", step: "02" },
    { icon: ThumbsUp, title: "Compare & Choose", description: "Review quotes and choose the best Somerville fencer.", step: "03" },
  ];
  return (
    <section className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">How It Works in Somerville</h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">Getting quotes for your Somerville fencing project is easy.</p>
        </div>
...
export default SomervilleHowItWorks;
