...
interface PakenhamFAQSectionProps {
  onQuoteClick?: () => void;
}
const PakenhamFAQSection = ({
  onQuoteClick
}: PakenhamFAQSectionProps) => {
  const handleQuoteClick = () => {
    window.location.href = QUOTE_URL;
  };
  const faqs = [{
    question: "How much does fencing installation cost in Pakenham?",
    answer: "Pakenham fencing Installation costs depend on the fencing material, height, total length, and site conditions. As a guide from our Pakenham verified fencing contractors, timber fencing starts from $65 per metre, Colorbond fencing starts from $75 per metre, and pool-safe fencing options can start from $60 per metre. Prices may increase for steeper blocks, rocky soil, retaining requirements, or old fence removal. For the most accurate price, use our instant fencing quote tool — it gives you a fast online estimate and matches you with local fencing experts who'll provide detailed on-site pricing."
  }, {
    question: "How long does it take to install a fence in Pakenham?",
    answer: "A standard residential fence (20–30m) in Pakenham usually takes around 1–2 days to install. Larger fencing jobs, sloping blocks, retaining requirements, or custom designs may take 3–7 days. Pool fencing, due to compliance checks and certification rules, typically takes 1–4 days. After reviewing your property, your matched local fencing contractors will confirm the exact installation timeline during the quoting stage."
  }, {
    question: "Do I need council approval for my fence in Pakenham?",
    answer: "In Pakenham most residential fences under 2 metres don't require council approval, but rules can vary depending on your estate area. Approval is often required for boundary fences on corner blocks, heritage-listed properties, high-traffic locations, or fences that exceed standard height limits. Our verified Pakenham local fencing contractors understand council regulations in Pakenham and will guide you through the approval or permit process if needed."
  }, {
    question: "What's the best fencing material for my property in Pakenham?",
    answer: "It depends on your goals and the style of your home in Pakenham. Colorbond fencing is incredibly durable, low-maintenance, and ideal for harsh Australian weather conditions. Timber fencing offers a natural, warm look but requires periodic maintenance. Aluminium slat fencing provides a modern appearance with excellent durability, while glass fencing is a premium option perfect for pools, outdoor areas, and homes wanting an open, stylish finish. After reviewing your property, Pakenham local fencing contractors can recommend the best material based on your privacy needs, style preferences, budget, and long-term value."
  }, {
    question: "Are the fencing contractors in Pakenham verified and insured?",
    answer: "Yes. Every fencing contractor on our platform in Pakenham is fully licensed, insured, and professionally vetted before they're allowed to quote. We verify their experience, trade credentials, public liability insurance, and customer reviews to ensure you're only connected with reliable, experienced, and proven fencing professionals in your Pakenham local area."
  }, {
    question: "How many quotes will I receive?",
    answer: "You'll typically receive up to 3 competitive quotes from reputable Pakenham local fencing experts within hours. This lets you compare pricing, availability, experience, and workmanship. There's absolutely no obligation — you simply choose the fencing contractor who best suits your project and budget."
  }, {
    question: "Can you repair or replace an existing fence in Pakenham?",
    answer: "Absolutely. Whether you need simple fence repairs (broken palings, leaning posts, storm damage) or a complete fence replacement, our Pakenham local fencing contractors can help. They'll inspect the fence, explain your repair-vs-replacement options, and provide honest advice to ensure you get the most cost-effective solution for your property."
  }, {
    question: "What happens after I submit my quote request?",
    answer: "Within minutes, we'll match you with up to 3 qualified local fencing professionals in Pakenham. They'll contact you to discuss your job, arrange a site visit if required, and provide detailed written fencing quotes. You review the quotes, ask any questions, and choose the fencing contractor that best suits your project — all at your own pace with zero pressure."
  }, {
    question: "How long will my fence last in Pakenham?",
    answer: "Fence lifespan depends on the material and Pakenham area climate. A well-installed Colorbond fence or aluminium fence can last 20–30 years, while timber fencing generally lasts 10–20 years with proper care. Regular maintenance, high-quality installation, and choosing the right fencing material for the Pakenham area all play a major role in how long your fence will last."
  }, {
    ...
    question: "Do I need my neighbour's approval for a new boundary fence in Pakenham?",
    ...
    question: "How close to the boundary can I build my fence in Pakenham?",
    ...
    question: "How do I choose the right fence for my home in Pakenham?",
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Got questions about fencing in Pakenham? We've got answers. Here's everything you need to know about
            getting your perfect fence installed in Pakenham.
          </p>
        </div>
        ...
        <div className="text-center mt-12 p-8 rounded-2xl bg-gradient-to-r from-primary/5 via-accent/5 to-primary/5 border border-accent/20">
          ...
          <p className="text-muted-foreground mb-6">
            Our local fencing experts in Pakenham are here to help. Get your free quotes and ask them anything!
          </p>
