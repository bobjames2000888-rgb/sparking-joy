...
const BurwoodFAQSection = () => {
  const faqs = [
    { question: "How much does fencing cost in Burwood?", answer: "Colorbond typically costs $75-$120/m, timber $65-$140/m, aluminium pool fencing $150-$300/m." },
    { question: "Do I need a permit for fencing in Burwood?", answer: "In Burwood (Whitehorse Council), fences under 2m generally don't require a permit." },
    { question: "What's the best fence for Burwood?", answer: "Colorbond and timber are both popular in Burwood's established suburban setting." },
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Burwood Fencing FAQs</h2>
