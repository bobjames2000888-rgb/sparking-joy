...
const MelbourneSorrento = () => {
  useDocumentTitle("Sorrento Fencing Quotes — Get 3 Free Quotes in Minutes");
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        <SuburbHeroSection suburbName="Sorrento" />
        <SuburbHowItWorks suburbName="Sorrento" />
        <div id="fence-types"><SuburbFenceTypes suburbName="Sorrento" /></div>
        <div id="reviews"><ReviewsSection /></div>
        <div id="faq"><SuburbFAQSection suburbName="Sorrento" /></div>
      </main>
      <Footer />
    </div>
  );
