...
const MelbourneLangwarrin = () => {
  useDocumentTitle("Langwarrin Fencing Quotes — Get 3 Free Quotes in Minutes");
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        <SuburbHeroSection suburbName="Langwarrin" />
        <SuburbHowItWorks suburbName="Langwarrin" />
        <div id="fence-types"><SuburbFenceTypes suburbName="Langwarrin" /></div>
        <div id="reviews"><ReviewsSection /></div>
        <div id="faq"><SuburbFAQSection suburbName="Langwarrin" /></div>
      </main>
      <Footer />
    </div>
  );
