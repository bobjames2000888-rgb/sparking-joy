...
const MelbourneCarrumDowns = () => {
  useDocumentTitle("Carrum Downs Fencing Quotes — Get 3 Free Quotes in Minutes");
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        <SuburbHeroSection suburbName="Carrum Downs" />
        <SuburbHowItWorks suburbName="Carrum Downs" />
        <div id="fence-types"><SuburbFenceTypes suburbName="Carrum Downs" /></div>
        <div id="reviews"><ReviewsSection /></div>
        <div id="faq"><SuburbFAQSection suburbName="Carrum Downs" /></div>
      </main>
      <Footer />
    </div>
  );
