...
const TimberFencing = () => {
  ...
  const benefits = [{ icon: Trees, title: "Natural Beauty", description: "Timeless aesthetic that complements any property style and landscape" }, { icon: Palette, title: "Fully Customisable", description: "Choose from various timber types, stains, and styles to match your vision" }, { icon: Leaf, title: "Eco-Friendly", description: "Sustainable and renewable material that's environmentally responsible" }, { icon: Ruler, title: "Versatile Designs", description: "From privacy screens to decorative pickets, endless design possibilities" }];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Timber Fencing Solutions<br /><span className="text-gradient"></span></h1>
            ...
            <div className="relative"><div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-elegant"><img src="/lovable-uploads/timber-fence-hero.webp" alt="Timber Fence Installation" className="w-full h-full object-cover" /></div></div>
          </div>
        </div>
      </section>
      <section className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12"><h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Why Choose Timber Fencing?</h2><p className="text-lg text-muted-foreground max-w-2xl mx-auto">Classic beauty meets modern durability with Australian timber fencing solutions</p></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-8">Every timber fence our verified contractors install are built to last, using local materials and expert installation techniques that ensure longevity and beauty.</p>
            ...
            <div className="relative"><div className="aspect-square rounded-2xl overflow-hidden shadow-elegant"><img alt="Timber Fencing Features" className="w-full h-full object-cover" src="/lovable-uploads/4d010175-bbb4-455d-8657-91465e4c67e0.webp" /></div></div>
          </div>
        </div>
      </section>
      <section id="timber-types" className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12"><h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Choose Your Timber Type</h2><p className="text-lg text-muted-foreground max-w-2xl mx-auto">Select from Australian timbers, each with unique characteristics</p></div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="accent-gradient rounded-2xl p-12 shadow-elegant">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to Install Your Timber Fence?</h2>
