  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Custom variants for fencing website
        hero: "accent-gradient text-accent-foreground hover:shadow-accent hover:scale-105 transition-bounce font-semibold shadow-strong",
        quote: "bg-accent text-accent-foreground hover:bg-accent/90 hover:shadow-accent transition-bounce font-semibold px-8 py-3 text-base shadow-soft",
        nav: "text-foreground hover:text-accent hover:bg-accent/10 transition-smooth",
