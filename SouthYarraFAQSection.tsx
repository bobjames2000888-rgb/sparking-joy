...
const SomervilleFAQSection = () => {
  const faqs = [
    { question: "How much does fencing cost in Somerville?", answer: "Colorbond typically costs $75-$120/m, timber $65-$140/m, aluminium pool fencing $150-$300/m." },
    { question: "Do I need a permit for fencing in Somerville?", answer: "In Somerville (Mornington Peninsula Shire), fences under 2m generally don't require a permit." },
    { question: "What's the best fence for Somerville?", answer: "Timber is popular in Somerville's semi-rural setting. Colorbond is also excellent for low maintenance." },
    ...
    { question: "What areas do you service?", answer: "Somerville and surrounds including Hastings, Tyabb, Baxter, Mornington." },
    ...
    { question: "Do you service rural properties?", answer: "Yes! We handle rural fencing including larger acreage properties in Somerville." },
  ];
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Somerville Fencing FAQs</h2>
...
export default SomervilleFAQSection;
