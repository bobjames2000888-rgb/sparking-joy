...
import { Check, ShieldCheck, Lock, Camera, AlertTriangle, Award } from "lucide-react";
...
const SecurityFencing = () => {
  ...
  const handleSecurityOptions = () => {
    scrollToSection("security-applications");
  };
  const benefits = [{
    icon: ShieldCheck,
    title: "Maximum Protection",
    description: "Heavy-duty construction designed to deter and prevent unauthorised access"
  }, {
    icon: Lock,
    title: "Anti-Climb Design",
    description: "Specialised profiles and spikes make scaling virtually impossible"
  }, {
    icon: Camera,
    title: "Integration Ready",
    description: "Compatible with CCTV, sensors, and electronic access systems"
  }, {
    icon: AlertTriangle,
    title: "Visible Deterrent",
    description: "Professional appearance sends a clear security message"
  }];
  ...
  const applications = [{
    name: "Commercial",
    description: "Warehouses & office complexes",
    icon: commercialSecurityIcon
  }, {
    name: "Industrial",
    description: "Factories & storage yards",
    icon: industrialSecurityIcon
  }, {
    name: "Government",
    description: "Schools & public facilities",
    icon: governmentSecurityIcon
  }, {
    name: "Critical Infrastructure",
    description: "Utilities & data centres",
    icon: criticalInfrastructureSecurityIcon
  }];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center space-x-2 bg-primary/10 px-4 py-2 rounded-full mb-6">
                ...
                <span className="text-sm font-medium text-primary">Maximum Protection</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Security<br />
                <span className="text-gradient">Fencing Systems</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Button variant="outline" size="lg" onClick={handleSecurityOptions}>
                  Security Options
                </Button>
              </div>
            ...
            <div className="relative">
              <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-elegant">
                <img src="/lovable-uploads/security-fence-hero.webp" alt="Security Fence Installation" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Professional-grade perimeter protection for high-value properties
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="aspect-square rounded-2xl overflow-hidden shadow-elegant">
                <img src="/lovable-uploads/security-fence-features.webp" alt="Security Fencing Features" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="security-applications" className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Tailored security solutions for every industry and application
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="accent-gradient rounded-2xl p-12 shadow-elegant">
            ...
            <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
              Get a free security assessment and quotes for your perimeter protection needs
            </p>
